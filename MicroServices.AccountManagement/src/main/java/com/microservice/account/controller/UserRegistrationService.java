...
import com.microservice.account.AccountManager;
...
public class UserRegistrationService {
	 ...
	 * Once data is saved to Mongo db, below method return CustomerBO object backt as an output. becuase we 
	...
	@ResponseBody
	public Object addUser(@RequestBody CustomerBO user) {
	...
	@ResponseBody
	public List<CustomerBO> findUsers(@PathVariable String key,@PathVariable String value) {
		return (List<CustomerBO>) acctManager.findUsers(key, value);
